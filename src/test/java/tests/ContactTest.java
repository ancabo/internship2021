...
public class ContactTest extends TestBase{
	...
	public void verifyContactButton() {
		...
		logReport("Pass", "Contact button ok");
	...
	public void verifyContactText(){
		...
		logReport("Info", "Contact us text ok");
		...
		logReport("Info", "Talk to us text ok");
...
//		
	...
	public void verifyMap(){
		...
		logReport("Info", "Terms of use link ok");
		...
		logReport("Info", "Report a map error button link ok");
